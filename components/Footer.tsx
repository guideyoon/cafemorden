    ...
    <footer className="bg-warm-gray border-t border-gray-200 mt-20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-xl font-serif font-bold text-warm-brown mb-4">
              {siteData.name}
            </h3>
            <p className="text-gray-700">{siteData.tagline}</p>
          </div>
          <div>
            <h4 className="font-bold mb-4 text-warm-brown">연락처</h4>
            <div className="space-y-2">
              <a
                href={`tel:${siteData.phone}`}
                className="flex items-center gap-2 text-gray-700 hover:text-warm-brown transition-colors"
              >
          ...
          <div>
            <h4 className="font-bold mb-4 text-warm-brown">영업시간</h4>
